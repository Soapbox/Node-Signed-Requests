...
describe("RequestSignerMiddleware", () => {
  ...
  it("sets the correct headers on the request by default", async () => {
    nock(baseURL)
      .get("/")
      .reply(function(uri: string, requestBody: string): any {
  ...
  describe("id header", () => {
    ...
    it("sets the id header with the correct value", async () => {
      nock(baseURL)
        .get("/")
        .reply(function(uri: string, requestBody: string): any {
  ...
  describe("timestamp header", () => {
    ...
    it("sets the timestamp header with the correct value", async () => {
      nock(baseURL)
        .get("/")
        .reply(function(uri: string, requestBody: string): any {
  ...
  describe("algorithm header", () => {
    ...
    it("sets the algorithm header with the correct value", async () => {
      nock(baseURL)
        .get("/")
        .reply(function(uri: string, requestBody: string): any {
  ...
  describe("signature header", () => {
    ...
    it("contains the proper value for simple POSTs", async () => {
      nock(baseURL)
        .post("/")
        .reply(function(uri: string, requestBody: string): any {
    ...
    it("contains the proper value for simple POSTs containing ã character", async () => {
      nock(baseURL)
        .post("/")
        .reply(function(uri: string, requestBody: string): any {
          expect(this.req.headers[defaultConfig.headers.signature]).to.equal(
    ...
    it("contains the proper value for simple POSTs containing 好 character", async () => {
      nock(baseURL)
        .post("/")
        .reply(function(uri: string, requestBody: string): any {
          expect(this.req.headers[defaultConfig.headers.signature]).to.equal(
    ...
    it("contains the proper value for simple POSTs containing a url", async () => {
      nock(baseURL)
        .post("/")
        .reply(function(uri: string, requestBody: string): any {
          expect(this.req.headers[defaultConfig.headers.signature]).to.equal(
    ...
    it("contains the proper value for complex POSTs", async () => {
      nock(baseURL)
        .post("/poop")
        .reply(function(uri: string, requestBody: string): any {
          expect(this.req.headers[defaultConfig.headers.signature]).to.equal(
    ...
    it("contains the proper value when the URL has a trailing slash", async () => {
      nock(baseURL)
        .post("/poop/")
        .reply(function(uri: string, requestBody: string): any {
          expect(this.req.headers[defaultConfig.headers.signature]).to.equal(
